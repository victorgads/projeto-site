...
function validarEmail() {
    ...
    if (email.value.length < 6 || email.value.length > 85) {
        emailSpan.innerHTML = `<span style='color:red'>Seu email deve ter mais de 6 letras e no máximo 85</span>`;
        return false;
    }
    //Verificar se o email não contem nenhum caracter especial que não é aceito
        ...
        emailSpan.innerHTML = `<span style='color:red'>Seu email só pode conter letras, números e (.)</span>`;
        return false;
    }
    ...
    //Verificar se o dominio do email é válido
        ...
        emailSpan.innerHTML = `<span style='color:red'>Seu email não tem um dominio válido</span>`;
        return false;
    }

    //Mostra na tela que o email é valido
    else {
        emailSpan.innerHTML = `<span style='color:green'>Seu email é válido</span>`;
        return true;
    }
}
...
function validarSenha() {
    ...
    if (password.value.length <= 7) {
        senhaSpan.innerHTML = `<span style='color:red'>Sua senha é muito fraca</span>`;
        return false;
    }
    ...
    //Verificar se a senha possui alguma letra minuscula.
        ...
        senhaSpan.innerHTML = `<span style='color:red'>Sua senha é fraca</span>`;
        return false;
    }

    // Verificar se tem letras maisculas 
    else if (password.value.indexOf("A") < 0 && password.value.indexOf("B") < 0 && password.value.indexOf("C") < 0 && password.value.indexOf("D") < 0 && password.value.indexOf("E") < 0 && password.value.indexOf("F") < 0 && password.value.indexOf("G") < 0 && password.value.indexOf("H") < 0 && password.value.indexOf("I") < 0 && password.value.indexOf("J") < 0 && password.value.indexOf("K") < 0 && password.value.indexOf("L") < 0 && password.value.indexOf("M") < 0 && password.value.indexOf("N") < 0 && password.value.indexOf("O") < 0 && password.value.indexOf("P") < 0 && password.value.indexOf("Q") < 0 && password.value.indexOf("R") < 0 && password.value.indexOf("S") < 0 && password.value.indexOf("T") < 0 && password.value.indexOf("U") < 0 && password.value.indexOf("V") < 0 && password.value.indexOf("W") < 0 && password.value.indexOf("X") < 0 && password.value.indexOf("Y") < 0 && password.value.indexOf("Z") < 0) {
        senhaSpan.innerHTML = `<span style='color:yellow'>Sua senha é mediana</span>`;
        return false;
    }
    ...
    //Verificar se a senha possui algum caracter especial.
        ...
        senhaSpan.innerHTML = `<span style="color:yellow">Sua senha está ficando forte</span>`
        return false;
    }

    //Mostra na tela que a senha é forte
    else {
        senhaSpan.innerHTML = `<span style='color:green'>Sua senha é forte</span>`;
        return true;
    }
}
...
function confirmarSenha() {
    ...
    if (senha.value != confirmacaoSenha.value) {
        confirmarSenhaSpan.innerHTML = `<span style='color:red'>Suas senhas não coincidem</span>`;
        return false;
    }

    //Mostra na tela que as senhas são iguais
    else {
        senhaSpan.innerHTML = `<span style='color:green'>Suas senhas coincidem</span>`;
        return true;
    }
}
...
function validarCampo() {
    ...
    if (nome == "" || email == "" || senha == "" || confirmacaoSenha == "") {
        validarCampo.innerHTML = `<span style='color:red'>Você deve preencher todos os campos antes de seguir para a próxima tela.</span>`;
    }
    //Verifica se algum campo digitado é inválido
    else if (validarEmail() == false || validarSenha() == false || ConfirmarSenha() == false) {
        validarCampo.innerHTML = `<span style='color:red'>Um dos seus campos é inválido.</span>`;
    }
